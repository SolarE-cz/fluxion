...
//! Economic Optimizer
//!
//! This module implements the core optimization engine that evaluates multiple
//! strategies for each time block and selects the most economically profitable one.
//!
//! The optimizer:
//! 1. Evaluates all enabled strategies for a given time block
//! 2. Compares their expected net profit (revenue - costs)
//! 3. Selects the strategy with the highest net profit
//! 4. Returns the complete evaluation with decision rationale
//!
//! This approach ensures objective, transparent decision-making based on
//! quantifiable economic merit rather than arbitrary weights.
