...
//! Morning Pre-Charge Strategy
//!
//! Charges battery during the 3-4 cheapest night blocks (22:00-08:00) before morning peak prices,
//! but only if there's a significant price difference (>0.5 CZK) between morning peak and night minimum.
//!
//! Key features:
//! - Identifies morning peak price (06:00-10:00)
//! - Finds 3-4 cheapest blocks during night (22:00-08:00)
//! - Only charges if morning peak - night minimum > 0.5 CZK
//! - Targets 80-90% SOC for morning readiness
