...
//!
//! This strategy prioritizes storing solar energy in the battery for later use
//! rather than immediately exporting it to the grid. It's particularly beneficial
//! when:
//! - Future grid import prices are expected to be higher than current export prices
//! - Household has predictable evening consumption peaks
//! - Solar generation is abundant but grid export prices are low
//!
//! Economic considerations:
//! - Opportunity cost of not exporting solar immediately
//! - Battery degradation from storing solar energy
//! - Round-trip efficiency losses
//! - Value of using stored solar during high-price periods
//!
//! The strategy compares:
//! 1. Immediate export revenue (export price × solar energy)
//! 2. Future value of stored solar (avoiding high import prices later, minus losses)
