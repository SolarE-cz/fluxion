...
//! Self-Use Strategy
//!
//! This strategy represents normal battery operation where the battery
//! is used to optimize self-consumption of solar energy and reduce grid imports.
//!
//! The strategy evaluates the profit from:
//! - Storing solar energy for later consumption (avoiding grid imports)
//! - Using stored battery energy to meet household demand
//! - Exporting excess solar when battery is full
//!
//! Economic considerations:
//! - Battery degradation cost for each kWh cycled
//! - Round-trip efficiency losses
//! - Grid import prices avoided
//! - Grid export revenue from excess solar
