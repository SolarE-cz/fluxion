...
//! Time-Aware Charge Strategy
//!
//! This strategy intelligently charges the battery during low-price periods to avoid
//! purchasing expensive grid energy during high-price hours. It considers:
//! - Full day price analysis to identify cheapest charging opportunities
//! - Upcoming high-price periods and expected consumption during those periods
//! - Current battery SOC and predicted depletion
//! - Time-based SOC targets for evening preparation (80% by 15:00, 100% by 17:00)
//!
//! Key features:
//! 1. Charges during absolute lowest prices (e.g., 3:30 AM) even if above time targets
//! 2. Predicts battery depletion and pre-charges to cover expensive periods
//! 3. Prioritizes cheap charging to avoid grid import during peak pricing
//! 4. Only charges when solar generation is minimal
