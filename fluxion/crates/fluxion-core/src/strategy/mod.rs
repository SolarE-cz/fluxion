...
//! Economic strategy evaluation for battery scheduling
//!
//! This module implements an economic optimization approach where different
//! strategies compete based on their expected profit/cost rather than arbitrary
//! weights. Each strategy evaluates the profitability of operating the battery
//! in a specific mode for each time block.
