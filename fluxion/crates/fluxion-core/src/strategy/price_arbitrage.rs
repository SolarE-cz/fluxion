...
//!
//! This strategy exploits price differences by:
//! - Charging the battery from grid during low-price periods (Force Charge)
//! - Discharging the battery to grid during high-price periods (Force Discharge)
//!
//! The strategy evaluates whether the price spread is sufficient to cover:
//! - Battery round-trip efficiency losses
//! - Battery degradation costs
//! - Grid import costs
//!
//! Only profitable arbitrage opportunities are recommended.
