...
/// Async systems using channel-based communication
///
/// This module contains systems that set up and manage long-running async workers
/// that communicate with the ECS world via channels.
