...
//! Internationalization (i18n) support for fluxion using Mozilla's Fluent framework.
//!
//! This crate provides translation capabilities for the FluxION system, currently supporting
//! Czech and English languages with the ability to add more languages in the future.
//!
//! # Architecture
//!
//! - Translation files are stored in `locales/{language}/{domain}.ftl`
//! - The `I18n` struct provides the main API for translation
//! - Bevy ECS integration is available via `I18nResource`
//! - Supports variable interpolation and pluralization via Fluent
//!
//! # Example
//!
//! ```no_run
...
//!
//! let i18n = I18n::new(Language::Czech).expect("Failed to load translations");
//! let text = i18n.get("web-battery-soc").expect("Translation key not found");
//!
//! // With variables
//! let formatted = i18n.format("schedule-cheapest-block", Some(&fluent_args![
//!     "price" => 0.123,
//!     "currency" => "Kč"
...
impl Language {
    ...
    /// Get the language display name in English
    #[must_use]
