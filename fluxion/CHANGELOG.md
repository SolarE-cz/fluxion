...
- [ ] Additional inverter brand support (Goodwe, Deye)
...
- [ ] Advanced forecasting with machine learning (paid feature)
- [ ] Dynamic pricing strategy optimization (paid feature)
...
**License:** Licensed under the Creative Commons Attribution-NonCommercial-NoDerivatives 4.0
International (CC BY-NC-ND 4.0). You may use and share this file for non-commercial purposes only
and you may not create derivatives. See <https://creativecommons.org/licenses/by-nc-nd/4.0/>.
